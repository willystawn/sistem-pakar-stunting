!(function (l) {
  ...
  l("#sidebarToggle, #sidebarToggleTop").on("click", function (e) {
    ...
    // Penambahan margin left
    l("#sidebarToggleTop").toggleClass("sidebar-margin-left");
  });

  l(window).resize(function () {
    l(window).width() < 768 && l(".sidebar .collapse").collapse("hide"),
      l(window).width() < 400 && !l(".sidebar").hasClass("toggled") && (l("body").addClass("sidebar-toggled"), l(".sidebar").addClass("toggled"), l(".sidebar .collapse").collapse("hide"));
  });
